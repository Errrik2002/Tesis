...
alpha1_Macrofagos_inf <- readRDS("analisis_sensibilidad_param_signos_bien/alpha1_Mi.rds")
alpha1_Macrofagos_inf
##

alpha2_cardiomiocitos_no_infec <- readRDS("analisis_sensibilidad_param_signos_bien/alpha2_Cn.rds")
alpha2_cardiomiocitos_no_infec
##
alpha4_Cardiomiocito_no_infec <- readRDS("analisis_sensibilidad_param_signos_bien/alpha4_Cn.rds")
alpha4_Cardiomiocito_no_infec

alpha4_Macrofagos_infectados <- readRDS("analisis_sensibilidad_param_signos_bien/alpha4_Mi.rds")
alpha4_Macrofagos_infectados

alpha4_trypanosoma_libre <- readRDS("analisis_sensibilidad_param_signos_bien/alpha4_TL.rds")
alpha4_trypanosoma_libre
##
alpha5_cardiomiocito_no_infec <- readRDS("analisis_sensibilidad_param_signos_bien/alpha5_Cn.rds")
alpha5_cardiomiocito_no_infec

alpha5_macrofagos_infectados <- readRDS("analisis_sensibilidad_param_signos_bien/alpha5_Mi.rds")
alpha5_macrofagos_infectados

alpha5_parasitos_libres <- readRDS("analisis_sensibilidad_param_signos_bien/alpha5_TL.rds")
alpha5_parasitos_libres

alpha5_TNF <- readRDS("analisis_sensibilidad_param_signos_bien/alpha5_TNF.rds")
alpha5_TNF
##

alpha7_IL10<- readRDS("analisis_sensibilidad_param_signos_bien/alpha7_IL10.rds")
alpha7_IL10
##

mu5_macrofagos_infectados <- readRDS("analisis_sensibilidad_param_signos_bien/mu5_Mi.rds")
mu5_macrofagos_infectados
##
mu7_cardiomiocito_no_infectado <- readRDS("analisis_sensibilidad_param_signos_bien/mu7_Cn.rds")
mu7_cardiomiocito_no_infectado

mu7_IL10 <- readRDS("analisis_sensibilidad_param_signos_bien/mu7_IL10.rds")
mu7_IL10

mu7_Macrofagos_infectados <- readRDS("analisis_sensibilidad_param_signos_bien/mu7_Mi.rds")
