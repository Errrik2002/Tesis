...
| Parametro     | Valor            | Definicion                                      | Referencia     |
|---------------------|-----------------|-----------------|-----------------|
| $\nu_{1}$ |-----------------|Tasa de entrada de parasitos|-----------------|
| $\alpha_{1}$ |-----------------|Tasa de fagocitosis de Macrofagos|-----------------|
| $\alpha_{2}$ |-----------------|Tasa de infeccion de cardiomiocitos|-----------------|
| $\mu_{1}$ |-----------------|Muerte de pareasito libre|-----------------|
| $\nu_{2}$ |-----------------| Proliferacion de Macrofagos |-----------------|
| $\mu_{2}$ |-----------------| Tasa de muerte de macrofago |-----------------|
| $\nu_{3}$ |-----------------| Proliferacion de cardiomiocitos |-----------------|
| $\mu_{3}$ |-----------------| Muerte de cardiomiocitos |-----------------|
| $\mu_{4}$ |-----------------| Tasa de muerte de Trypanosoma intracelular |-----------------|
| $\alpha_{3}$ |-----------------| Tasa de proliferacion en $C_{i}$ |-----------------|
| $\alpha_{4}$ |-----------------| Tasa de proliferacion en $M_{i}$ |-----------------|
| $\mu_{6}$ |-----------------| Muerte de cardiomiocito infectado |-----------------|
| $\alpha_{5}$ |-----------------| Secrecion de TNF-$\alpha$ |-----------------|
| $\alpha_{6}$ |-----------------| Secrecion de IFN-$\gamma$ |-----------------|
| $\alpha_{6}$ |-----------------| Secrecion de IL-10 |-----------------|
